...
import { getOAuthUrlControler, loginUserControler, loginWithGoogleController, logoutUserControler, refreshUserControler, registerUserControler, resetPasswordController, sendResetPasswordEmail} from "../controllers/auth.js";
...
authRouter.post('/get-oauth-url', ctrlWrapper(getOAuthUrlControler), );
authRouter.post('/verify-google-oauth',validateBody(validateGoogleOAuth),ctrlWrapper(loginWithGoogleController), );
